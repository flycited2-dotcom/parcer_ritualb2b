"""Поиск через Яндекс (yandex.ru/search/) — широкая матрица по 4 регионам.

На РФ-IP yandex.ru даёт прямой доступ. При капче парсер логирует и переходит
к следующему запросу. Цель — собрать прямые сайты ритуальных компаний с title.
...
BROAD_CITY_QUERIES = [
    ...
    "ритуальный магазин {city}",
    "памятники надгробия {city} официальный сайт",
    "венки {city}",
