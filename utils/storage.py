...
# Реальные источники ritual-парсера (раньше тут были отельные Авито/Суточно).
_SOURCE_PRIORITY = {
    "OSM": 6,        # структурированные теги — самые чистые контакты
    "Я.Карты": 5,    # телефоны с карточек организаций
    "VK": 4,
    "Crawler": 3,    # контакты с сайтов компаний
    "Поиск": 2,
    "Wikipedia": 1,
    "Wikidata": 1,
}
